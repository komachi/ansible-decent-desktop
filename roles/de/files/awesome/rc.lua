...
local function set_wallpaper(s)
    gears.wallpaper.set("#000000", s, true)
end
...
tyrannical.tags = {
    ...
    },
    {
        ...
        layout      = awful.layout.suit.tile,
        class = {
            "xterm", "x-terminal-emulator", "XTerm", "URxvt"
        }
    },
    {
        name        = "mpv",
...
tyrannical.properties.intrusive = {
    "pinentry", "gtksu",
    "Gradient editor", "Paste Special", "Background color","Xephyr", 
}
...
tyrannical.properties.floating = {
    ...
    "New Form", "Insert Picture", "mythfrontend"
}
